...
<th>Edit</th>
	...
	while($row = mysqli_fetch_array($res))
	{
		...
		//to show the image in table(viewing db in web)
...
<form name="myForm" method="POST" action="handler.php" id="n_form">
...
<form name="editForm" id="e_form" method="POST" action="formhandle.php" enctype="multipart/form-data">
